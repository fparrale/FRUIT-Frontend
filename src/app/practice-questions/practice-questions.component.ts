...
import { Question, QuestionTransformed } from '../questions/interfaces/Questions';
...
export class PracticeQuestionsComponent  implements OnInit{
  ...
  private generateDynamicOptions(correctWord: string): string[] {
    ...
    return Array.from(new Set([correctWord, ...options])); // Evitar duplicados y garantizar que esté la correcta
  }

  transformQuestions(questions: Question[]): QuestionTransformed[] {
